...
class RegistrasiController extends Controller
{
    ...
    {
        $totalHariIni = Registrasi::whereDate('tanggal_registrasi', today())->count();

        $totalRajal = Registrasi::where('tipe_rawat', 'J')
            ->whereDate('tanggal_registrasi', today())
            ->count();

        $totalIgd = Registrasi::where('tipe_rawat', 'G')
            ->whereDate('tanggal_registrasi', today())
            ->count();

        $totalRanap = Registrasi::where('tipe_rawat', 'I')
            ->whereDate('tanggal_registrasi', today())
            ->count();
    ...
    public function data(Request $request)
    {
        ...
        $query = Registrasi::query()
            ...
            ->select(
                ...
                'pasien.jenis_kelamin','pasien.no_bpjs',
